...
namespace PoorMansTSqlFormatterLib.Formatters
{
    public class TSqlObfuscatingFormatter : ISqlTreeFormatter
    {
        ...
        public string FormatSQLTree(Node sqlTreeDoc)
        {
            ...
            var state = new TSqlObfuscatingFormattingState(RandomizeColor, RandomizeLineLength);
        ...
        {
            var keywordCharArray = outputKeyword.ToCharArray();
            for (var i = 0; i < keywordCharArray.Length; i++)
            {
