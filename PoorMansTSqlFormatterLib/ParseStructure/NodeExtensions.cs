    ...
    public static class NodeExtensions
    {
        ...
        public static Node ExtractStructureBetween(Node startingElement, Node endingElement)
        {
            ...
            while (currentNode != null)
            {
                ...
                {
                    var copyOfThisNode = NodeFactory.CreateNode(currentNode.Name, currentNode.TextValue);
                    ...
                    {
                        var copyOfThisNodesParent = NodeFactory.CreateNode(currentNode.Parent.Name, currentNode.Parent.TextValue);
